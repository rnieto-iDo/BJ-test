...
import ProductViewer from '../../planner/ProductViewer';
...
const RoomPlanner = () => {
    ...
    return (
        <div className=" grid w-full grid-cols-[1fr,_40%]  overflow-hidden font-haasUnica">
            <div
            ...
            >
                ...
                {!isOpenMenu && (
                    <button onClick={handleToggle} className="absolute px-20 py-4 border-2 border-black top-10 right-10" type="button">
                        Menu
                    </button>
                )}
                {/* / / /  */}
            ...
            <div className={`transition-all duration-500 ease-in-out w-full relative border-l-2 overflow-hidden ${isOpenMenu ? 'col-span-1' : 'hidden'} row-start-1 row-end-1`}>
